...
func (s *GeoIPService) Lookup(ip string) (*domain.GeoIPResult, error) {
...
func (s *GeoIPService) lookupIpWhoIs(ip string) (*domain.GeoIPResult, error) {
...
func (s *GeoIPService) lookupFreeIPAPI(ip string) (*domain.GeoIPResult, error) {
