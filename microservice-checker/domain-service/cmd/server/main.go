...
import (
	...
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/domain-service/internal/infrastructure/database"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/domain-service/internal/infrastructure/logger"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/domain-service/internal/infrastructure/server"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/domain-service/internal/module/domain_mgmt"
	custommiddleware "github.com/hidessh99/sub-cf-vpn/microservice-checker/domain-service/internal/shared/middleware"
)
...
func main() {
	...
	// Initialize SQLite database for domains
	dbPath := filepath.Join(cwd, "data", "domain.db")
	...
	port := cfg.Port
	log.Info(fmt.Sprintf("Domain Service running on http://0.0.0.0:%d", port), "System")
	go func() {
