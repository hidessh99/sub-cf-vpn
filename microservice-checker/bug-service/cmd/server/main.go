...
import (
	...
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/bug-service/internal/infrastructure/database"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/bug-service/internal/infrastructure/logger"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/bug-service/internal/infrastructure/server"
	"github.com/hidessh99/sub-cf-vpn/microservice-checker/bug-service/internal/module/bug"
	custommiddleware "github.com/hidessh99/sub-cf-vpn/microservice-checker/bug-service/internal/shared/middleware"
)
...
func main() {
	...
	// Initialize SQLite database for bugs
	dbPath := filepath.Join(cwd, "data", "bug.db")
	...
	port := cfg.Port
	log.Info(fmt.Sprintf("Bug Service running on http://0.0.0.0:%d", port), "System")
	go func() {
