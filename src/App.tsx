...
const ProxyManagement = React.lazy(() => import('./pages/admin/ProxyManagement').then(m => ({ default: m.ProxyManagement })));
const DomainManagement = React.lazy(() => import('./pages/admin/DomainManagement').then(m => ({ default: m.DomainManagement })));
const BugManagement = React.lazy(() => import('./pages/admin/BugManagement').then(m => ({ default: m.BugManagement })));
