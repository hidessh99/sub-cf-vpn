    ...
    <AdminLayout>
      <div className="flex flex-col gap-6 w-full max-w-4xl">
        <div className="flex justify-between items-center w-full">
          <div>
            <h2 className="text-2xl font-bold text-white tracking-tight">Bug Hostname Management</h2>
            <p className="text-slate-400 text-sm mt-1">Manage SNI / Bug hostnames that are allowed in configurations</p>
          </div>
          <button
